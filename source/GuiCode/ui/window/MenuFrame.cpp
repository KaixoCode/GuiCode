...
{
    if (m_Component)
        Size((int)std::max((m_Component->Width() + 2) / m_Scale, 5.0f), (int)std::max((m_Component->Height() + 2) / m_Scale, 5.0f));

    m_Panel->Size({ m_Size.width + (int) (2 / m_Scale), (int)((m_Size.height + 2 / m_Scale)) });
